...
exports.config = {
    ...
    //baseUrl: process.env.SUT_URL || 'http://the-internet.herokuapp.com',
    //baseUrl: process.env.SUT_URL || 'http://uitestingplayground.com', http://the-internet.herokuapp.com/
    //
    ...
    beforeSession: function (config, capabilities, specs) {
        require('expect-webdriverio').setOptions({ wait: 5000, interval: 500})
    },
    /**
